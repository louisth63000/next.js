  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="relative w-full h-48 bg-gray-300 overflow-hidden">
        <img 
          src="https://s1.qwant.com/thumbr/474x237/a/5/df2b9d94f4cf1ba11049dfcea616361a169504a41294c10acf02618e3a1e77/th.jpg?u=https%3A%2F%2Ftse.mm.bing.net%2Fth%3Fid%3DOIP.5dvyeE1qpWp6HHtoc6PwtQHaDt%26pid%3DApi&q=0&b=1&p=0&a=0" 
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  {finishedMatches.map((match, index) => (
                    <MatchRow key={`finished-${index}`} {...match} />
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  {futureMatches.map((match, index) => (
                    <MatchRow key={`future-${index}`} {...match} />
                  ))}
                </div>
              </div>
            </CardContent>
